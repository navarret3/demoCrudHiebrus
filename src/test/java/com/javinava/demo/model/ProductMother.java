...
public class ProductMother {
	...
	public static List<Product> products = new ArrayList<>(Arrays.asList(ProductMother.PRODUCT_1,
			ProductMother.PRODUCT_2, ProductMother.PRODUCT_3, ProductMother.PRODUCT_4));
}
